...
public class 1 extends AbstractLanguageAnalyser {
  ...
  /**
   * Execute this pr over the current document.
  ...
  public void execute() throws ExecutionException {
    ...
    // long.
    if(isInterrupted()) {
      throw new ExecutionInterruptedException("Execution of pr has been interrupted!");
    }
    interrupted = false;
